...
<nav class="side-navbar">
  ...
  <ul class="list-unstyled">
    <li class="active"> <a href="./Admin.Dashboard.php"><i class="fa fa-user-circle-o"></i>Dashboard</a></li>
    ...
    <li><a href="#payment" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-money"></i>Payment</a>
